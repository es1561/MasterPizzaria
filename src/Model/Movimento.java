...
public class Movimento
{
    ...
    public Object searchByCompra()
    {
        Object list = null;
        String sql = "SELECT * FROM Movimento WHERE comp_cod = ?";
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                Movimento obj = new Movimento(rs.getInt("mov_cod"), rs.getInt("mov_tipo"), rs.getDouble("mov_valor"), (Caixa) new Caixa(rs.getDate("mov_data")).searchByData(), ped, comp);
